...
een voorbeeld:
python3 main.py buy --product-name orange --price 2 --expire-date 2022-04-03 --amount 5
...
Bijvoorbeeld:
python3 main.py export --import-file stock --export-file data --start-date 2022-04-03 --end-date 2022-04-08



U kunt ook de bestandformaat aanpassen naar xlsx of naar csv
u kunt de argument --file-extension gebruiken een voorbeeld :
python3 main.py export --import-file stock --export-file data --start-date 2022-04-03 --end-date 2022-04-08 --file-extension csv
